...
async function ubidotsDeviceCreation(ubidotsUrl, ubidotsToken, deviceName, deviceLabel, depth, soil) {
    var deviceBody = {
...
async function main(params) {
    ...
    var _plugin_env_varLabelSoilMoisture = params._plugin_env_varLabelSoilMoisture; // Ubidots soil moisture variable label 
    ...
    for (var i = 0; i < size; i++) {
        ...
        await ubidotsDeviceCreation(_plugin_env_ubidotsUrl, ubidotsToken, deviceName, deviceLabel, probeDepth(depthId), probeSoil(soilId));
        /* Post to Ubidots */
        postResponse = await ubidotsPost(_plugin_env_ubidotsUrl, ubidotsToken, deviceLabel, payload);
    }
    return postResponse;
}